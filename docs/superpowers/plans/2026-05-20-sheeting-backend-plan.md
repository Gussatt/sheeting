...
- [ ] _Testing Checkpoint:_ Write basic API tests (using Vitest + Supertest) to verify the Transactions and Tags endpoints work against a test database.
...
- [ ] _Verification:_ Ensure all frontend tests pass using the mocked API calls.
