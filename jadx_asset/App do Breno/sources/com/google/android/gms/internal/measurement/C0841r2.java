...
public final class C0841r2 extends V4 implements InterfaceC0868u5 {
    private static final C0841r2 zzb;
    private int zzd;
    private String zze = "";
    private String zzf = "";

    static {
        C0841r2 c0841r2 = new C0841r2();
        zzb = c0841r2;
        V4.A(C0841r2.class, c0841r2);
    }
    ...
    public final Object E(int i4, Object obj, Object obj2) {
        ...
        if (i5 == 4) {
            return new C0834q2(abstractC0865u2);
        }
        if (i5 == 5) {
            return zzb;
        }
