...
public final class DynamiteModule {
    ...
    public static Boolean f6272h = null;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static String f6273i = null;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    public static boolean f6274j = false;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    public static int f6275k = -1;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static Boolean f6276l;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static d1.i f6281q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static j f6282r;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f6283a;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final ThreadLocal f6277m = new ThreadLocal();

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final ThreadLocal f6278n = new C0918f();

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final b.a f6279o = new com.google.android.gms.dynamite.a();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final b f6266b = new com.google.android.gms.dynamite.b();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final b f6267c = new c();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final b f6268d = new d();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final b f6269e = new e();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final b f6270f = new f();

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final b f6271g = new g();

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final b f6280p = new h();
    ...
    public static class a extends Exception {
        public /* synthetic */ a(String str, d1.h hVar) {
            super(str);
        }

        public /* synthetic */ a(String str, Throwable th, d1.h hVar) {
            super(str, th);
        }
    }
    ...
    public interface b {
        ...
        C0115b a(Context context, String str, a aVar);
    }
    ...
    public static int a(Context context, String str) {
        try {
            ...
            if (AbstractC0548g.a(declaredField.get(null), str)) {
    ...
    */
    public static com.google.android.gms.dynamite.DynamiteModule d(android.content.Context r21, com.google.android.gms.dynamite.DynamiteModule.b r22, java.lang.String r23) throws java.lang.Throwable {
        /*
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static int f(android.content.Context r12, java.lang.String r13, boolean r14, boolean r15) throws java.lang.Throwable {
        /*
    ...
    public static boolean i(Cursor cursor) {
        d1.g gVar = (d1.g) f6277m.get();
        if (gVar == null || gVar.f7145a != null) {
            return false;
        }
        gVar.f7145a = cursor;
        return true;
    ...
    public static boolean j(Context context) {
        ...
        if (bool.equals(null) || bool.equals(f6276l)) {
            return true;
        }
        boolean z3 = false;
        if (f6276l == null) {
            ProviderInfo providerInfoResolveContentProvider = context.getPackageManager().resolveContentProvider("com.google.android.gms.chimera", true != k.f() ? 0 : 268435456);
            if (C0513k.f().h(context, 10000000) == 0 && providerInfoResolveContentProvider != null && "com.google.android.gms".equals(providerInfoResolveContentProvider.packageName)) {
                z3 = true;
            }
            f6276l = Boolean.valueOf(z3);
    ...
    public static d1.i k(Context context) {
        d1.i iVar;
        synchronized (DynamiteModule.class) {
            ...
            try {
                ...
                if (iBinder == null) {
                    ...
                    iVar = iInterfaceQueryLocalInterface instanceof d1.i ? (d1.i) iInterfaceQueryLocalInterface : new d1.i(iBinder);
                }
                if (iVar != null) {
                    f6281q = iVar;
                    return iVar;
    ...
    public IBinder c(String str) throws a {
        try {
            return (IBinder) this.f6283a.getClassLoader().loadClass(str).newInstance();
