    ...
    public final boolean z(int i4, int i5) {
        ...
        for (int i6 = 0; i6 < childCount; i6++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == AbstractC0641e.f5639B) {
                    view = childAt;
                } else if (id == AbstractC0641e.f5646g) {
                    view2 = childAt;
                } else {
                    if ((id != AbstractC0641e.f5648i && id != AbstractC0641e.f5649j) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
